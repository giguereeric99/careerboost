...
CREATE OR REPLACE FUNCTION "public"."create_resume_complete"("p_clerk_id" "text", "p_original_text" "text", "p_optimized_text" "text", "p_language" "text" DEFAULT 'en'::"text", "p_ats_score" integer DEFAULT 65, "p_file_url" "text" DEFAULT NULL::"text", "p_file_name" "text" DEFAULT NULL::"text", "p_file_type" "text" DEFAULT NULL::"text", "p_file_size" integer DEFAULT NULL::integer, "p_ai_provider" "text" DEFAULT NULL::"text", "p_keywords" "text"[] DEFAULT ARRAY[]::"text"[], "p_suggestions" "jsonb" DEFAULT '[]'::"jsonb", "p_reset_last_saved_text" boolean DEFAULT true) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_resume_complete"("p_clerk_id" "text", "p_original_text" "text", "p_optimized_text" "text", "p_language" "text", "p_ats_score" integer, "p_file_url" "text", "p_file_name" "text", "p_file_type" "text", "p_file_size" integer, "p_ai_provider" "text", "p_keywords" "text"[], "p_suggestions" "jsonb", "p_reset_last_saved_text" boolean) OWNER TO "postgres";
...
CREATE INDEX "idx_keywords_resume_applied" ON "public"."resume_keywords" USING "btree" ("resume_id", "is_applied");
...
CREATE INDEX "idx_resumes_user_created" ON "public"."resumes" USING "btree" ("auth_user_id", "created_at" DESC);



CREATE INDEX "idx_suggestions_resume_applied" ON "public"."resume_suggestions" USING "btree" ("resume_id", "is_applied");



CREATE INDEX "idx_user_mapping_active_users" ON "public"."user_mapping" USING "btree" ("subscription_status", "subscription_plan") WHERE ("subscription_status" = 'active'::"text");
...
GRANT ALL ON FUNCTION "public"."create_resume_complete"("p_clerk_id" "text", "p_original_text" "text", "p_optimized_text" "text", "p_language" "text", "p_ats_score" integer, "p_file_url" "text", "p_file_name" "text", "p_file_type" "text", "p_file_size" integer, "p_ai_provider" "text", "p_keywords" "text"[], "p_suggestions" "jsonb", "p_reset_last_saved_text" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."create_resume_complete"("p_clerk_id" "text", "p_original_text" "text", "p_optimized_text" "text", "p_language" "text", "p_ats_score" integer, "p_file_url" "text", "p_file_name" "text", "p_file_type" "text", "p_file_size" integer, "p_ai_provider" "text", "p_keywords" "text"[], "p_suggestions" "jsonb", "p_reset_last_saved_text" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_resume_complete"("p_clerk_id" "text", "p_original_text" "text", "p_optimized_text" "text", "p_language" "text", "p_ats_score" integer, "p_file_url" "text", "p_file_name" "text", "p_file_type" "text", "p_file_size" integer, "p_ai_provider" "text", "p_keywords" "text"[], "p_suggestions" "jsonb", "p_reset_last_saved_text" boolean) TO "service_role";
