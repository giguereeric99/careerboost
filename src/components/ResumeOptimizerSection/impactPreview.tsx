...
const ImpactContent: React.FC<
	Omit<ImpactPreviewProps, "isCollapsible" | "defaultOpen">
> = ({
	currentScore,
	newScore,
	pointImpact,
	...
	return (
		<div className="flex items-center justify-between">
			...
			<div className="flex-1 mr-4">
				...
				{isApplied && (
					<span className="mt-2 px-3 py-1 text-xs font-medium text-green-600 bg-green-50 rounded-full border border-green-200 flex items-center">
					...
					<div className="flex items-center justify-between mb-2">
						<div className="flex items-center">
							...
							<h4 className="text-sm font-medium">
								{getImpactLabel(props.impactLevel)}
							</h4>
						</div>
