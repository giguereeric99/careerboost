...
import { Sparkles, Check, BarChart2, Lock } from "lucide-react";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
    ...
    <div className="bg-brand-50 border border-brand-100 rounded-lg p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {!isEditing && (
            <Tooltip>
              ...
              <TooltipContent>
                <p className="text-xs">Click "Edit" button on the resume to apply suggestions</p>
              </TooltipContent>
            </Tooltip>
          )}
        </div>
                      ...
                      <div key={groupIndex} className="px-4 py-3">
                        <div className="flex justify-between items-start">
                            ...
                            {showImpactScore && impact && (
                              <Badge 
                                ...
                                className={`mt-2 text-xs ${
                                  impactLevel === ImpactLevel.CRITICAL ? "bg-red-50 text-red-600 border-red-200" :
                                  impactLevel === ImpactLevel.HIGH ? "bg-orange-50 text-orange-600 border-orange-200" :
                                  impactLevel === ImpactLevel.MEDIUM ? "bg-blue-50 text-blue-600 border-blue-200" :
                          ...
                          <Button 
                            ...
                            onClick={() => handleApplySuggestion(suggestionIndex)}
      ...
      {!isEditing && (
        <div className="mt-3 text-xs text-gray-500 bg-gray-50 p-2 rounded-lg border border-gray-200">
          Click the "Edit" button on the resume to apply suggestions.
        </div>
      )}
    </div>
  );
