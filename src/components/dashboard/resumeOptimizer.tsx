...
// Import centralized data normalizers
import {
  normalizeSuggestion,
  normalizeKeyword,
...
const ResumeOptimizer: React.FC = () => {
  ...
  const {
    ...
    onOptimizationComplete: (
      ...
      // Use centralized normalizers to ensure consistent data structure
   ...
   * Uses the centralizes normalizer to ensure consistent structure
   * Adds the 'applied' property required by KeywordsList component
   */
  const mappedKeywords = keywords.map((k) => {
    const normalizedKeyword = normalizeKeyword({
      ...
      id: k.id || undefined,
      text: k.text || "",
      isApplied: k.isApplied || k.applied || false,
    ...
    // Ensure both isApplied and applied fields exist for compatibility
    return {
      ...normalizedKeyword,
      applied: normalizedKeyword.isApplied,
    };
  });
        ...
        <TabsContent value="upload" className="space-y-4">
          <UploadSection
            ...
            onAnalysisComplete={(
              ...
              // Use centralized normalizers for data consistency
              ...
              <div className="grid md:grid-cols-5 gap-6">
                ...
                <div className="col-span-2 flex flex-col gap-4">
                  ...
                  <ScoreCard
                    ...
                    keywordsApplied={
                      keywords.filter((k) => k.isApplied || k.applied).length
                    }
